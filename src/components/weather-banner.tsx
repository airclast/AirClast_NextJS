...
export default function WeatherBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 p-8 mb-8 animate-fade-in-up">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div className="flex-1 space-y-4">
          <div className="animate-slide-in">
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-2 text-balance">Dhaka, Bangladesh</h1>
          ...
          <div className="flex items-center gap-8 animate-slide-in" style={{ animationDelay: "0.2s" }}>
            <div className="text-center">
              <div className="text-6xl lg:text-7xl font-light text-white mb-2 animate-pulse-subtle">28°</div>
            ...
            <div className="space-y-2 text-white/80">
              ...
              <p className="text-sm">
                High: <span className="text-orange-200">35°</span> • Low: <span className="text-blue-200">24°</span>
              </p>
              <p className="text-sm">
        ...
        <div className="flex-shrink-0 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <div className="relative">
            ...
            <div className="w-56 h-56  bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20">
              <div className="text-8xl lg:text-9xl animate-pulse-subtle">🌫️</div>
            </div>
